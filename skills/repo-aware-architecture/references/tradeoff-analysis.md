...
Lead with the recommended option and explain why it wins for the current drivers. Record rejected alternatives and the decisive reason; avoid lengthy catalogs of minor differences.
