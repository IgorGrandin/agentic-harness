...
Link rather than duplicate detailed specs, diagrams, or research. Supersede an earlier decision explicitly instead of silently rewriting history when the repository convention preserves ADR history.
